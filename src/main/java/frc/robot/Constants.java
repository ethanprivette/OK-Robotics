...
public final class Constants {
    ...
    public static final int LEFT_TALON_PWM = 9;
    public static final int RIGHT_TALON_PWM = 7;

    public static final int LEFT_ENCODER_DIO_1 = 9;
    public static final int LEFT_ENCODER_DIO_2 = 8;

    public static final int RIGHT_ENCODER_DIO_1 = 7;
    public static final int RIGHT_ENCODER_DIO_2 = 6;
    ...
    public static final int ELEVATOR_TALON_PWM = 8;

    public static final int ELEVATOR_ENCODER_DIO_1 = 5;
    public static final int ELEVATOR_ENCODER_DIO_2 = 4;
